<template>
  <div class="m4:py-5">
    ...
    <div class="text-center py-5">
      <h1 class="text-2xl m4:text-5xl font-bold pb-2 pt-3 bg-transparent bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-purple-500 to-red-500">
        {{ $t('our_class') }}
      </h1>
      <p class="text-sm max-w-80 sx:max-w-[400px] m4:max-w-lg text-gray-800 dark:text-gray-200">{{ $t('choose_class_prompt') }}</p>
    </div>

    <div class="flex flex-col m4:flex-row items-center gap-4 m4:pt-12 m4:py-6">
      <input
        v-model="searchQuery"
        type="text"
        :placeholder="$t('search_lesson')"
        class="m4:w-80 text-sm m4:text-base w-72 sl:w-[340px] sx:w-[400px] px-4 py-2 text-gray-800 dark:text-gray-200 rounded-full border border-gray-200/50 dark:border-gray-700/50 shadow-[0_0_8px_rgb(50_50_50)] dark:shadow-[0_0_8px_rgb(100_100_100)] bg-gray-200 dark:bg-gray-800 border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
    ...
    <!-- Heading -->
    <h2 class="m4:text-2xl text-xl font-bold mb-4 text-gray-800 dark:text-gray-200 py-5">{{ $t('gold_special_lessons') }}</h2>
    ...
    <!-- Heading -->
    <h2 class="text-xl m4:text-2xl font-bold pt-5 m4:pt-10 pb-5 text-gray-800 dark:text-gray-200">{{ $t('lessons_coming_soon') }}</h2>
    ...
    <div class="grid grid-cols-1 m4:grid-cols-3 justify-center items-center gap-8">
      ...
      >
        <div class="relative bg-black overflow-hidden">
          ...
          <span class="absolute top-1/2 left-1/2 -translate-x-1/2 bg-gradient-to-r from-red-500 to-purple-500 backdrop-blur-sm text-white text-sm m4:text-base font-bold px-4 py-2 -rotate-12 group-hover:rotate-0 rounded-full transition-all duration-300">{{ $t('coming_out_soon') }}</span>
        </div>
        <div class="p-4 relative h-56">
